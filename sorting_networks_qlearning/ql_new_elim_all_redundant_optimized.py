...
nume_fisier = "ql_new_elim_all_redundant.txt"
...
class LayeredSortingNetworkEnv:
    def __init__(self, n_wires, max_comparators):
        ...
        self.depth = 0
        # with open(nume_fisier, 'a') as fisier:
        #     fisier.write("1" + "\n")
        # print("1")
...
class QLearningAgent:
    ...
    def choose_action(self, state):
        ...
        # filtrare lista actiuni valide, pastraza doar comparatoarele care au efect real
...
if __name__ == "__main__":
    ...
    print(f"\nTimpul de executie a fost: {execution_time:.2f} secunde")
